...
<div class="homepage-header">
	<?php if ( has_post_thumbnail() ) { ?>
		<div class="homepage-header-background" style="background-image:url( <?php the_post_thumbnail_url( 'full' ); ?> )"></div>
	<?php } ?>
	<div class="container">
		<h1>Original &amp; Powerful WordPress Themes</h1>
		<p>We specialize in creating some of the Best Free and Premium WordPress Themes. Subscribe and get access to our entire collection.</p>
...
<div class="homepage-sections sidebar-none">
	...
	<section id="homepage-themes" class="homepage-section">
		<section id="pagetitle" class="pagetitle">
			<div class="container">
				<h1 class="pagetitle-title heading">Latest themes</h1>
	...
	<section id="homepage-testimonials" class="white-section homepage-section content">
		<div class="pagetitle">
			<h1 class="pagetitle-title heading">What People Say About Us</h1>
			<div class="pagetitle-subtitle">
		...
		<div class="container">
			<div class="row cpo-row">
				...
				<div class="col2 column">
					<div class="cpo-testimonial">
						<div class="cpo-testimonial-content">
							I have used CPOThemes now for two client projects and have found their themes to be easy to use and customize. The documentation is extensive and support is excellent. If you are looking for easy themes to use for your websites, then why not try out CPOThemes. I’m very happy that I gave them a go.
						</div>
						<div class="cpo-testimonial-author">
	...
	<section id="homepage-testimonials" class="homepage-section content">
		<div class="pagetitle">
			<h1 class="pagetitle-title heading">Premium-Grade Features</h1>
			<div class="pagetitle-subtitle">
					...
					<div class="cpo-block">
						<div class="cpo-feature cpo-feature-has-icon">
							...
							<div class="cpo-feature-body">
								...
								<div class="cpo-feature-content">Build a professional-looking website by using a modern design that promotes trust. Make your content shine in every device out there thanks to responsive design.</div>
							</div>
						</div>
					...
					<div class="cpo-block">
						<div class="cpo-feature cpo-feature-has-icon">
							...
							<div class="cpo-feature-body">
								...
								<div class="cpo-feature-content">Install your theme quickly and seamlessly, and get new features and updates on the fly with a single click. We continuously improve our themes and enhance them.</div>
							</div>
						</div>
						<div class="cpo-clear"></div>
					</div>
					<div class="cpo-block">
						<div class="cpo-feature cpo-feature-has-icon">
							...
							<div class="cpo-feature-body">
								...
								<div class="cpo-feature-content">Build your site in a matter of minutes thanks to the theme handling all the hard work for you. Focus on creating great content and forget the fight with layout options.</div>
							</div>
						</div>
						<div class="cpo-clear"></div>
					</div>
					...
					<div class="cpo-block">
						<div class="cpo-feature cpo-feature-has-icon">
							...
							<div class="cpo-feature-body">
								...
								<div class="cpo-feature-content">Forget about getting locked-in to using the same WordPress theme forever. Enjoy using powerful functionality that respects the end user without barriers.</div>
							</div>
						</div>
						<div class="cpo-clear"></div>
					</div>
					<div class="cpo-block">
						<div class="cpo-feature cpo-feature-has-icon">
							...
							<div class="cpo-feature-body">
								...
								<div class="cpo-feature-content">Install your favorite plugins and let the theme speak directly to them, saving hours of work integrating their functionality into your website. The days of lock-in are over.</div>
							</div>
						</div>
						<div class="cpo-clear"></div>
					</div>
					<div class="cpo-block">
						<div class="cpo-feature cpo-feature-has-icon">
							...
							<div class="cpo-feature-body">
								...
								<div class="cpo-feature-content">Browse through the detailed knowledge base to get answers to just about any question, and get in touch directly with us to get your theme up and running in no time.</div>
							</div>
						</div>
						<div class="cpo-clear"></div>
					</div>
