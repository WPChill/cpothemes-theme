		...
		public function notices() {
			...
			if ( ! get_user_meta( get_current_user_id(), 'tgmpa_dismissed_notice', true ) ) {
				...
				if ( ! empty( $message ) ) {
					...
					$notice .= '<a class="cpothemes-notice-dismiss" style="font-weight:normal;" href="'.add_query_arg('tgmpa-dismiss', 'dismiss_admin_notices').'" target="_parent">'.__('Dismiss This Notice', 'cpotheme').'</a>';
					$notice .= '<img class="cpotheme-wizard-image" src="'.$core_path.'images/ct-icon.png">';
					$notice .= '<span class="cpotheme-wizard-title" style="display:block; margin:0 0 5px; font-size:1.3em;">'.sprintf(__('Install Recommended Plugins', 'cpotheme'), CPOTHEME_NAME).'</span>';
