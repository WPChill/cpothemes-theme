...
if(!function_exists('cpotheme_setup')){
	...
	function cpotheme_setup(){
		...
		if(defined('CPOTHEME_CORE')) $languages_path = CPOTHEME_CORE.'/languages';
...
if(!function_exists('cpotheme_scripts_front')){
	...
	function cpotheme_scripts_front( ){
		...
		if(defined('CPOTHEME_CORE_URL')) $scripts_path = CPOTHEME_CORE_URL.'/scripts/';
...
if(!function_exists('cpotheme_add_styles')){
	...
	function cpotheme_add_styles(){
		...
		if(defined('CPOTHEME_CORE_URL')) $stylesheets_path = CPOTHEME_CORE_URL.'/css/';
